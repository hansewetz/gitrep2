...
template<typename Queue>using eventdir_queue_listener=basic_queue_listener<basic_queue_listener_service<>,eventdir_queue<typename Queue::value_type,typename Queue::deserialiser,typename Queue::serialiser>>;
...
template<typename Queue>using eventdir_queue_sender=basic_queue_sender<basic_queue_sender_service<>,eventdir_queue<typename Queue::value_type,typename Queue::deserialiser,typename Queue::serialiser>>;
}
}
#endif
