...
int main(){
  ...
  unicode_input_iterator<utf8_tag,istreambuf_iterator<char>>uit_begin(make_unicode_input_iterator<utf8_tag>(sstr_it_begin));
  unicode_input_iterator<utf8_tag,istreambuf_iterator<char>>uit_end(make_unicode_input_iterator<utf8_tag>(sstr_it_end));
