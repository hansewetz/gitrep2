...
constexpr static char const*EXEDIR="/ec/prod/exodus/dgt/local/exodus/user/potocva/OPERATINGHOME/8thgen/ensv-all";
constexpr static char const*PROGPATH="/ec/prod/exodus/dgt/local/exodus/user/potocva/OPERATINGHOME/8thgen/ensv-all/translate";
