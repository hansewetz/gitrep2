...
private:
  ...
  // enqueue a message
  bool enqAux(std::size_t ms,boost::system::error_code&ec,bool sendMsg){
    boost::system::error_code ec1;

    // NOTE! Not yet done
    //   	wrap state manegement around 'sendwait()'
    // 		simple: similar to deqAux()
