...
export LD_LIBRARY_PATH=${INSTALL_HOME}/lib:${INSTALL_HOME}/lib64:${INSTALL_HOME}/lib:${INSTALL_HOME}/lib64:${INSTALL_EXTRA_HOME}/lib:${LD_LIBRARY_PATH}:${PROJECT_ROOT}/lib
